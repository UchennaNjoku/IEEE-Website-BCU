    ...
    <div style={backgroundStyle} className='relative'>
      ...
      <div className='relative h-full'>
        ...
        <div style={cardStyle} className='text-center bg-[#474747] opacity-70 absolute z-20 top-80 left-1/2 p-10 rounded-2xl'>
          ...
          <p className='text-gray-300 mt-7 text-2xl  font-inter'>"Equipped with 360 degrees of freedom, several sensors and a fully functional mechanical arm, Our bot can withstand a plethora of terrains deciphering navigation and task execution through a variety of situations".</p>
          <div className='rounded-lg hover:bg-slate-500 cursor-pointer px-7 py-3 mt-10 w-fit outline outline-1 text-lg font-inter font-medium outline-white'>Meet the Team...</div>
        </div>
      </div>
